        ...
        <main className="body-page">
            ...
            <section className="body-header" ref={headerRef}>
                ...
                <p className="body-count">
                    {/* The `serviceCount` string already interpolates {count};
                        printing products.length alongside it rendered "4 4 Services". */}
                    {t('serviceCount', { count: products.length })}
                </p>
            </section>
                        ...
                        {(getWarning(selectedProduct) ||
                            ...
                            <div className="body-warning-box">
                                ...
                                {/* The travel fee is stated here, among the
                                    service's other cautions. Home visits only. */}
                                {involvesHomeVisit(selectedProduct.availability) && (
                                    <TravelFeeNotice />
                                )}
                            </div>
